    ...
    <div className="Boddy">
      ...
      <div className="main disll gap_48">
        <div className="disll button_and_text">
          ...
          <p className="ts">The skills, tools and technologies I am really good at:</p>
        </div>
        <div className="wrp">
          <Logos />
        </div>
      ...
      <div className="midd_container gap_48 disll">
        <div className="disll button_and_text">
          ...
          <p className="ts">Here is a quick summary of my most recent experiences:</p>
        </div>
        <div className="gap_48">
          <Cards />
        </div>
      ...
      <div className="main gap_48 disll">
        ...
        <p className="ts">Some of the noteworthy projects I have built:</p>
        </div>
        <div className="fllx">
        ...
        <div className="pad48 card_ritght">
            <h2>Fiskil</h2>
            <p className="ts">Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br />Maecenas nec urna ac tellus volutpat viverra. Vestibulum ante <br /> ipsum primis in faucibus orci luctus et ultrices posuere cubilia <br /> curae.</p>
...
<path d="M10 14L21 3" stroke="#4B5563" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <div className="disll button_and_text fllx">
        ...
        <p className="ts fllx">What’s next? Feel free to reach out to me if you're looking for <br />  a developer, have a query, or simply want to connect.</p>
        </div>
        <div className="gap_16">
