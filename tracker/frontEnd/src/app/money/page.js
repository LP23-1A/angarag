    ...
    <div className="pt-[40px] pb-[399px] flex flex-col gap-[141px]">
      ...
      <div className="flex flex-col gap-[12px] justify-center items-center">
        <div className="flex flex-col gap-[24px]">
          ...
          <div>
            <select value={currency} onChange={(event) => setcurrency(event.target.value)} className="select select-bordered w-full max-w-xs">
              <option value="MNT" className="text-[#1F2937] text-[16px]">
        ...
        <div className="flex flex-col gap-[32px] justify-center items-center">
          ...
          <button
            onClick={handler}
            className="btn  bg-[#0166FF] text-[#FFF] w-[320px] rounded-[20px]"
          >
            Confirm{" "}
          </button>
        </div>
